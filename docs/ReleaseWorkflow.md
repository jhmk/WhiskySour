...
1. **Prepare runtime bundle**
   - Run `scripts/fetch-runtime.sh` locally to download Wine, DXVK, and cabextract into `Libraries/`, build `cabextract` with Autoconf/Automake, and produce `Libraries.tar.gz`.
